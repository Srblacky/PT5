    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.test5:
                    Intent intent = new Intent(Camera.this, BillInfoPayment.class);
                ...
                case R.id.test4:
                    ...
                    break;
                case R.id.test1:
                    Intent intent3 = new Intent(Camera.this, DisplayCustomerListPics.class);
                    startActivity(intent3);
                    break;
                case R.id.test2:
                    Intent intent4 = new Intent(Camera.this, ReceiptInfo.class);
                    startActivity(intent4);
                    break;
                case R.id.test3:
                    Intent intent5 = new Intent(Camera.this, ViewCustSessionCompleteAddSign.class);
                    startActivity(intent5);
                    break;
                case R.id.navigation_notifications:
                    Intent intent6 = new Intent(Camera.this, Main2Activity.class);
